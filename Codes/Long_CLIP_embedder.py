...
image_root = '/root/dws/MCS/Datasets/Urban1k/image/'
caption_root = '/root/dws/MCS/Datasets/Urban1k/caption/'
model_path = '/root/dws/Long-CLIP/checkpoints/longclip-L.pt'
class local_dataset(data.Dataset):
    def __init__(self):
        ...
        model, preprocess = longclip.load(model_path, device='cuda')
    def __len__(self):
