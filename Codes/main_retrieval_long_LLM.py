...
def I2T_fine_retrieval(texts_image_index,similarity_scores,llm_type,dataset_name,function, k=5):
    ...
    for i in tqdm(range(num_images)):
        ...
        reasoned_pred =function(I2T=True, image_path=image_sample, top_k_labels=topk_text_samples,is_saliency=False)
        try:
        ...
        i2t_logger.info(f'{i}|{num_images} ,text_retrieval_recall@1: {accuracy:.4f}')
...
def T2I_fine_retrieval(texts_image_index,similarity_scores,dataset_name,llm_type, function,k=5):
    # 创建专用的logger，避免与其他函数的日志混合
...
def main(dataset_name,llm_type,clip_type,function_1,function_2):
    ...
    I2T_accuracy = I2T_fine_retrieval(texts_image_index,scores,llm_type,dataset_name,function_2, k=5)
